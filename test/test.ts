...
const documentTests = [
    ...
    },
    {
        input: '```js\nconsole.log("Hola");\n```',
        expected: {
            output: '<div class="jt-yxtus jt-yxtus-code-block"><button class="jt-yxtus" onclick="navigator.clipboard.writeText(this.nextElementSibling.getAttribute(\'data-code\'));">Copy</button><pre class="jt-yxtus jt-yxtus-code" lang="js" data-code="console.log("Hola");"><div class="line"><span class="line-number">1</span><span class="code-line">console.log("Hola");</span></div></pre></div>',
            anchors: []
        }
    },
    {
        ...
        expected: {
            output: '<div class="jt-yxtus jt-yxtus-code-block"><button class="jt-yxtus" onclick="navigator.clipboard.writeText(this.nextElementSibling.getAttribute(\'data-code\'));">Copy</button><pre class="jt-yxtus jt-yxtus-code" data-code="console.log("Hola mundo");"><div class="line"><span class="line-number">1</span><span class="code-line">console.log("Hola mundo");</span></div></pre></div>',
            anchors: []
        }
    },
    {
        input: '````javascript\nconsole.log("Hola mundo");\n````',
        expected: {
            output: '<div class="jt-yxtus jt-yxtus-code-block"><button class="jt-yxtus" onclick="navigator.clipboard.writeText(this.nextElementSibling.getAttribute(\'data-code\'));">Copy</button><pre class="jt-yxtus jt-yxtus-code" lang="javascript" data-code="console.log("Hola mundo");"><div class="line"><span class="line-number">1</span><span class="code-line">console.log("Hola mundo");</span></div></pre></div>',
            anchors: []
        }
    },
    {
...
| *Body1.1* | | Body2.1 | ~Body4.1~ |`,
    ...
    },
    {
        ...
        expected: {
            output: '<a href="https://test.com" target="_blank" class="jt-yxtus jt-yxtus-link">Enlace</a>\n<code class="jt-yxtus jt-yxtus-code">https://example.com</code>\n<div class="jt-yxtus jt-yxtus-code-block"><button class="jt-yxtus" onclick="navigator.clipboard.writeText(this.nextElementSibling.getAttribute(\'data-code\'));">Copy</button><pre class="jt-yxtus jt-yxtus-code" data-code="GET https://api.example.com"><div class="line"><span class="line-number">1</span><span class="code-line">GET https://api.example.com</span></div></pre></div>',
            anchors: []
        }
    },
    {
    ...
    },
    {
        input: '```\nGET https://api.example.com\n```',
        expected: {
            output: '<div class="jt-yxtus jt-yxtus-code-block"><button class="jt-yxtus" onclick="navigator.clipboard.writeText(this.nextElementSibling.getAttribute(\'data-code\'));">Copy</button><pre class="jt-yxtus jt-yxtus-code" data-code="GET https://api.example.com"><div class="line"><span class="line-number">1</span><span class="code-line">GET https://api.example.com</span></div></pre></div>',
            anchors: []
        }
    },
    {
